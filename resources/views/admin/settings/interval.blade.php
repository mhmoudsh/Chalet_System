            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">بيانات الفترات</h4>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body card-dashboard">
                            ...
                            <a data-toggle="modal" href="#create"
                               data-target="#create" class="btn btn-primary btn-min-width btn-glow mr-1 mb-1">اضافة فترة زمنية
                                جديدة</a>
                            @endcan
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#edit" data-id="{{$info->id}}" data-name="{{$info->name}}"
                                               data-start_time="{{$info->start_time}}"  data-end_time="{{$info->end_time}}" data-price="{{$info->price}}"
                                               data-toggle="modal"
        ...
        <div class="modal fade text-left" id="create" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{route('Intervals.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="modal-body">
                         ...
                         {{ $message }}
                            ...
                            <div class="form-group">
                                <input type="time" value="{{old('start_time')}}" name="start_time" required class="form-control"
                                       data-validation-required-message="This field is required"
                         ...
                         {{ $message }}
                            ...
                            <div class="form-group">
                                <input type="time" value="{{old('end_time')}}" name="end_time" required class="form-control"
                                       data-validation-required-message="This field is required"
        ...
        <div class="modal fade text-left" id="delete" tabindex="-1" role="dialog" aria-labelledby="delete"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{route('Intervals.destroy','delete')}}" method="post">
                        @csrf
                        @method('delete')
                        <div class="modal-body">
                            <input type="hidden" name="id" id="id">
