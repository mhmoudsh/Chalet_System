...
<div class="col-12">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">اضافة موظف جديد</h4>
                                        ...
                                        <form action="{{route('employees.store')}}" method="post"  enctype="multipart/form-data" >
                                            ...
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{old('name')}}" name="name" required class="form-control" data-validation-required-message="This field is required" placeholder="ادخل  اسم الموظف ">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label> عنوان الموظف<span class="text-danger">*</span></label>
                                                            <input type="text" value="{{old('address')}}"  name="address" required class="form-control" placeholder="ادخل رقم هوية الموظف">
                                                        </div>
                                                        @error('address')
                                                        <span class="text-danger">
                                                        {{ $message }}
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input accept="image/*" class="form-group" name="image" type='file' id="imgInp" />
                                                            <br>
                                                            <img id="blah" src="{{asset('dashboard/app-assets/images/avatar.jpg')}}" style="height:100px; width: 100px; " alt="your image" />                                                                    </div>
                                                    </div>
                                                    @error('image')
                                                    <span class="text-danger">
                                                        {{ $message }}
