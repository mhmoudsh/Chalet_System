        ...
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body card-dashboard">
                            ...
                            <a href="{{route('employees.create')}}" class="btn btn-primary btn-min-width btn-glow mr-1 mb-1">اضافة موظف جديد</a>
                            @endcan
            ...
            @foreach($data as $info)
                <tr>
                    ...
                    <td><a href="{{route('employees.show',$info->id)}}"> {{$info->name}}</a></td>
                    <td>{{$info->phone}}</td>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-danger white">
                        <h4 class="modal-title white" id="delete">حذف الموظف</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form action="{{route('employees.destroy','delete')}}" method="post">
                        @csrf
                        @method('delete')
