            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">اضافة مسؤول جديد</h4>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" value="{{old('name')}}" name="name" required class="form-control" data-validation-required-message="This field is required" placeholder="ادخل  اسم المسؤول ">
                                                                    </div>
                                                                    @error('name')
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input required type="email"  name="email"   value="{{old('email')}}" class="form-control" placeholder="ادخل رقم البريد الاكتروني ">
                                                                    </div>
                                                                    @error('email')
                                                                    <span class="text-danger">
                                                                    {{ $message }}
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" value="{{old('address')}}"  name="address"  class="form-control" placeholder="ادخل رقم عنوان المسؤول">
                                                                    </div>
                                                                    @error('address')
                                                                    <span class="text-danger">
                                                                    {{ $message }}
