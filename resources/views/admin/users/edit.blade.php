            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">تعديل بيانات المشترك</h4>
                                                        ...
                                                        {{ $message }}
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <label>نوع المشترك <span
                                                                                class="text-danger">*</span></label>
                                                                        <br>

                                                                        <input type="checkbox" name="gender"
                                                                               class=" switch" id="switch10"
                                                                               data-on-title="1" data-off-title="0"
                                                                               data-off-label="مشترك"
                                                                               data-on-label="مشتركة"
                                                                               data-icon-cls="fa"
                                                                               data-off-icon-cls="icon-user"
                                                                               data-on-icon-cls="icon-user-female"
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <label>حالة المشترك <span
                                                                                class="text-danger">*</span></label>
                                                                        <br>

                                                                        <input type="checkbox" name="status"
                                                                               class=" switch" id="switch8"
                                                                               data-on-title="1"
                                                                               data-off-label="غير مفعل"
                                                                               data-on-label="مفعل" data-off-title="0"
