            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title "> بيانات المشترك</h4>
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">عمليات المشترك</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <ul class="nav nav-tabs nav-underline nav-justified">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" id="subscriptions-tab1" data-toggle="tab"
                                       href="#subscriptions"
                                       aria-controls="subscriptions" aria-expanded="true"><i class="ft-credit-card"></i>
                                        الاشتراكات </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " id="activeIcon12-tab1" data-toggle="tab"
                                       href="#activeIcon12"
                                       aria-controls="activeIcon12" aria-expanded="false"><i class="ft-credit-card"></i>
                                        سندات القبض</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <div class="tab-content px-1 pt-1">
                                <div role="tabpanel   " class="tab-pane  active" id="subscriptions"
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered sourced-data">
                                            ...
                                            <tbody>
                                            @foreach($data->userSubscriptions as $info)
                                                <tr>
                                                    <td>{{$loop->iteration}}</td>

                                                    <td><span
                                                            class="bg-primary text-white"> {{$info->subscription->name}}</span>
                                                    </td>
                                ...
                                <div role="tabpanel" class="tab-pane " id="activeIcon12"
                                     aria-labelledby="activeIcon12-tab1"
                                     aria-expanded="true">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered sourced-data">
                ...
                <div class="form-actions">
                    <div class="text-center">
                        <a href="{{route('users.index')}}" class="btn btn-primary">رجوع <i
                                class="ft-pocket"></i></a>
