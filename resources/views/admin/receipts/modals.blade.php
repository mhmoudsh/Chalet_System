    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <label class="modal-title text-text-bold-600" id="myModalLabel33">اضافة سند صرف جديد</label>
            ...
            <form action="{{route('receipts.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <label>المصروفات <span class="text-danger">*</span></label>
                        <input type="radio" value="3" name="type_user" required
                               data-validation-required-message="This field is required"
                               >
                    ...
                    @enderror
                    <div id="expenses-div" style="display: none">
                        <div class="d-block-flex ">
                            <div class="form-group ">
                                <label>نوع المصروفات<span class="text-danger">*</span></label>
                                <br>
                                <select  class="selectize " name="expenses_id" id="expenses_id"
                                         style="width: 470px">
...
<div class="modal fade text-left" id="delete" tabindex="-1" role="dialog" aria-labelledby="delete"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('receipts.destroy','delete')}}" method="post">
                @csrf
                @method('delete')
                <div class="modal-body">
                    <input type="hidden" name="id" id="id">
